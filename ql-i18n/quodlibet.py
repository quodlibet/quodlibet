...
class GladeHandlers(object):
    ...
    def select_scan(*args):
        resp, fns = make_chooser(_("Select Directories"))
    ...
    def open_chooser(*args):
        resp, fns = make_chooser(_("Add Music"))
        if resp == gtk.RESPONSE_OK:
