...
from quodlibet.util.massagers import (
    Massager,
    validate,
    is_valid,
    error_message,
...
class TMassagers(TestCase):
    ...
    def test_date_valid(self):
        self.validate(
            "date", ["2002-10-12", "2000", "1200-10", "0000-00-00", "1999/09/12"]
        )
    ...
    def test_date_equivs(self):
        self.equivs(
            "date",
            {"2000": "2000", "1999-99-99": "1999-99-99", "1999/12/09": "1999-12-09"},
        )
    ...
    def test_albumstatus(self):
        self.validate("musicbrainz_albumstatus", ["official", "promotional", "bootleg"])
        self.invalidate("musicbrainz_albumstatus", ["", "unofficial", "\x99"])
