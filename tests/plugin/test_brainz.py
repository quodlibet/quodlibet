    ...
    "release-list": [
        {
            ...
            "artist-credit": [
                {
                    "artist": {
                        "sort-name": "Necks, The",
                        "id": "51f8d454-f4a8-41e6-8bd7-a35921eeedd0",
                        "name": "The Necks",
                    }
                }
            ],
            "label-info-list": [
                {
                    "catalog-number": "FOM 0008",
                    "label": {
                        "id": "b887f682-e9e5-40d2-b4c7-cdbbcd2b3787",
                        "name": "Fish of Milk",
                    },
                }
            ],
            "title": "Athenaeum, Homebush, Quay & Raab",
            "country": "AU",
            "medium-count": 4,
            "release-event-list": [
                {
            ...
            "ext:score": "100",
            "date": "2002",
            "artist-credit-phrase": "The Necks",
            "release-group": {
                "secondary-type-list": ["Live"],
                "type": "Live",
                "id": "88e47489-a3d0-3344-864d-4b09188ba9e0",
                "primary-type": "Album",
            },
            "id": "3663a8a9-1c67-41c2-82c8-6a241d1558f7",
            "asin": "B00007FKRD",
        }
    ],
}
    ...
    "release-list": [
        {
            "artist-credit": [
                {
                    "artist": {
                        "alias-list": [
                            ...
                            {"alias": "Abba", "sort-name": "Abba"},
                            {
                                "alias": "Bj\xf6rn + Benny + Anna + Frieda",
                                "sort-name": "Bj\xf6rn + Benny + Anna + Frieda",
                            },
                        ],
            ...
            "artist-credit-phrase": "ABBA",
            "barcode": "602537784608",
            "country": "XW",
            "date": "2014-04-04",
            "ext:score": "100",
            "id": "9daa9d6e-7780-487f-9ef8-885755b73125",
            "label-info-list": [
                {
                    "label": {
                        "id": "91edee57-cbb2-44f4-a6c7-a1a022aead78",
                        "name": "Polar",
                    }
                }
            ],
            ...
            "release-group": {
                "id": "b69d665a-3eee-39f3-b156-58b122232304",
                "primary-type": "Album",
            ...
            "track-list": [
                {
                    ...
                    "number": "1",
                    "artist-credit-phrase": "Autechre & The Hafler Trio",
                    "recording": {
                        "artist-credit": [
                            {
                                "artist": {
                    ...
                    "track_or_recording_length": "974546",
                }
            ],
            "track-count": 1,
            "format": "CD",
            ...
            "track-list": [
                {
                    ...
                    "track_or_recording_length": "922546",
                }
            ],
            "track-count": 1,
            "format": "CD",
    ...
    "medium-list": [
        {
            ...
            "pregap": {
                "artist-credit": [
                    {
                        "artist": {
                            "id": "90b18d97-718b-4a95-982d-b14019d084c0",
                            "name": "Polarkreis 18",
...
class TBrainz(PluginTestCase):
    ...
    def test_build_query(self):
        ...
        self.assertEqual(build_query(album), '"blah" AND artist:"foo" AND tracks:2')
