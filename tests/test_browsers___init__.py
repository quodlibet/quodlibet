...
class TBrowsers(TestCase):
    def test_presence(self):
        self.failUnless(browsers.tracklist)
    ...
    def test_get(self):
        self.failUnless(browsers.get("SearchBar") is browsers.tracklist.TrackList)
        self.failUnless(
    ...
    def test_default(self):
        self.assertEqual(browsers.default, browsers.tracklist.TrackList)

    def test_name(self):
        self.assertEqual(browsers.name(browsers.tracklist.TrackList), "SearchBar")
