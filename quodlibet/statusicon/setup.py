...
setup(name = "pystatusicon", version = "2",
      url = "http://sacredchao.net/~piman/software/python.shtml",
      description = "notification area status icon for PyGTK",
...
is pressed, and 'popup-menu' when the right button is pressed.""",
      ext_modules=[
         Extension("statusicon",
                   ["statusicon.c", "eggstatusicon.c", "eggtrayicon.c",
                    "statusiconmodule.c", "eggmarshalers.c"],
